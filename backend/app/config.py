...
QDRANT_COLLECTION = os.environ.get("QDRANT_COLLECTION", "repository_openai_embedding_3_small")
QDRANT_TIMEOUT_SECONDS = _env_int("QDRANT_TIMEOUT_SECONDS", 60)
QDRANT_VECTOR_SIZE = _env_int("QDRANT_VECTOR_SIZE", 768)  # must match OPENAI_EMBEDDING_DIMENSION
...
# --- Embeddings ---
# Remote embeddings keep model weights and ONNX Runtime off a 512 MB host.
OPENAI_EMBEDDING_MODEL = os.environ.get("OPENAI_EMBEDDING_MODEL", "text-embedding-3-small")
OPENAI_EMBEDDING_DIMENSION = _env_int("OPENAI_EMBEDDING_DIMENSION", 768)
OPENAI_EMBEDDING_TIMEOUT_SECONDS = _env_int("OPENAI_EMBEDDING_TIMEOUT_SECONDS", 60)
OPENAI_EMBEDDING_MAX_RETRIES = _env_int("OPENAI_EMBEDDING_MAX_RETRIES", 6)
OPENAI_EMBEDDING_RETRY_BASE_SECONDS = _env_int("OPENAI_EMBEDDING_RETRY_BASE_SECONDS", 2)
EMBEDDING_BATCH_SIZE = _env_int("EMBEDDING_BATCH_SIZE", 16)

if QDRANT_VECTOR_SIZE != OPENAI_EMBEDDING_DIMENSION:
    raise ValueError("QDRANT_VECTOR_SIZE must equal OPENAI_EMBEDDING_DIMENSION")
